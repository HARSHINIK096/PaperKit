@echo off
title MASKERV Local Launcher
echo ===================================================
echo             Starting MASKERV Services            
echo ===================================================
echo.

:: Start the FastAPI backend service
echo [1/2] Launching Backend (FastAPI on Port 8000)...
start "MASKERV Backend" cmd /k "cd Services && .venv\Scripts\python -m uvicorn main:app --reload --port 8000"
